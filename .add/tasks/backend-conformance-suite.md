---
type: Task
title: One parametrized suite every backend must pass identically
status: direction
depth: deep
...
beat: scaffold · next: author backend-conformance-suite's RULES, ASSUMPTIONS and CHECKS, then add freeze backend-conformance-suite
