---
type: Task
title: Live sources stream results instead of accumulating them
status: direction
depth: standard
...
beat: scaffold · next: author cli-bounded-memory's RULES, ASSUMPTIONS and CHECKS, then add freeze cli-bounded-memory
