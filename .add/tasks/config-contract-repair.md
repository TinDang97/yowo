---
type: Task
title: Configs round-trip; no field bypasses its own validation
status: direction
depth: standard
...
depends_on:
  - /tasks/bounded-postprocess.md
  - /tasks/feature-cache-honesty.md
  - /tasks/precision-plumbing.md
...
beat: scaffold · next: author config-contract-repair's RULES, ASSUMPTIONS and CHECKS, then add freeze config-contract-repair
