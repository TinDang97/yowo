---
type: Task
title: Document and test the backend_instance= extension point
status: direction
depth: standard
...
beat: scaffold · next: author backend-extension-contract's RULES, ASSUMPTIONS and CHECKS, then add freeze backend-extension-contract
