---
type: Task
title: Every public name deliberate, in __all__, leaking no private type
status: direction
depth: deep
...
beat: scaffold · next: author public-surface-audit's RULES, ASSUMPTIONS and CHECKS, then add freeze public-surface-audit
