...
verified:
  ...
  - { by: loop, at: 2026-09-09, act: reopen, to: verify, reason: "Its planted-file fixture stopped reproducing the defect it was written against. The test plants an untracked, unignored file and asserts it does not enter the sdist; the vehicle was a .pt, chosen because ?? yolo11n.pt was the live defect. Commit 0a7d1f7 added *.pt to .gitignore as hazard reduction ahead of licensing-provenance, which made a planted .pt ignored and the scenario unreachable. The fixture detected this itself and failed loudly rather than passing vacuously. Vehicle swapped to .onnx - same FORBIDDEN_SUFFIXES list, covered by no ignore rule, identical defect class. M3 and E1 are unchanged and the check keeps its name, so the contract did not move; this is a verify-beat repair, not a re-direction." }
  - { by: "process:run", at: 2026-09-09, act: run, authority: process, outcome: PASS, receipt: /tasks/sdist-manifest.d/runs/2.md }
  - { by: "Tin Dang", at: 2026-09-09, act: gate, authority: human, outcome: PASS, receipt: /tasks/sdist-manifest.d/runs/2.md, brief: "sha256:241c9e7f95e1a262", reason: "Re-gated after its planted-file fixture stopped reproducing the defect. .gitignore gained *.pt as hazard reduction, which made the planted .pt ignored and the untracked-and-unignored scenario unreachable; the fixture asserted its own validity and failed loudly instead of going green and meaningless. Vehicle swapped to .onnx - same FORBIDDEN_SUFFIXES entry, no ignore rule covers it. M3, E1 and the check name are unchanged, so the frozen contract did not move. 9 passed." }
