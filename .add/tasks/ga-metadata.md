---
type: Task
title: Real maturity in metadata; a deployment and operations guide
status: direction
depth: quick
...
beat: scaffold · next: author ga-metadata's RULES, ASSUMPTIONS and CHECKS, then add freeze ga-metadata
