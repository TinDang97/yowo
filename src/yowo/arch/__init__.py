...
from yowo.arch._yolo import ClassifyModel, OBBModel, YOLOModel
from yowo.types import ModelFamily, ModelSize
...
def build_obb_model(
    ...
    *,
    ...
    """Build a YOLO OBB model for the given family and size.

    Args:
        family: Model family (YOLO11 or YOLO26).
        size: Size variant (nano … xlarge).
        num_classes: Number of output classes (default 15 for DOTA v1).

    Returns:
        An initialized ``OBBModel`` ready for weight loading.
